...
//        barStyle.body.grad_color = LV_COLOR_GRAY;
        barStyle.body.opa = LV_OPA_TRANSP;
...
void setupGui()
{
    ...
    //Create wallpaper
    void *images[] = {(void *) &bg, (void *) &bg1, (void *) &bg2, (void *) &bg3, (void *) &c64 };
    lv_obj_t *scr = lv_scr_act();
    lv_obj_t *img_bin = lv_img_create(scr, NULL);  /*Create an image object*/
    srand((int)time(0));
    int r = rand() % 4;
    lv_img_set_src(img_bin, images[4]);
    ...
    timeStyle.text.font = &c64_font_large;
